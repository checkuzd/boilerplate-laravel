...
class PowergridSettings extends Bootstrap5
{
    public string $name = 'bootstrap5';

    public function table(): Table
    {
        return Theme::table('table table-centered table-checkable table-highlight-head mb-2')
            ...
            ->trFilters('tr-filter')
            ->trBody('tr-body')
            ->th('th-head', 'white-space: nowrap;min-width: 50px;')
            ->tbody('')
    ...
    public function searchBox(): SearchBox
    {
        return Theme::searchBox()
            ...
            ->iconSearch('mdi mdi-table-search')
            ->iconClose('');
    }
}
