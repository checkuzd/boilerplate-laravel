(function () {
    var savedConfig = sessionStorage.getItem("__BOILERPLATE_CONFIG__");
    // var savedConfig = localStorage.getItem("__BOILERPLATE_CONFIG__");
    ...
    var layoutColor = html.getAttribute('data-theme');
